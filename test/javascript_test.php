...
<body>
	<p id=p1>Erster Absatz innerhalb des HTML-Dokuments</p>
	<p>Zeiter Absatz zum lernen von javascript</p>
	<script type="text/javascript">
      var ptags = document.getElementsByTagName('p');
      alert(ptags[0].innerHTML);
      ptags[0].innerHTML = 'Doof mann';
      console.log(ptags);
    </script>
	<script type="text/javascript">
      var eigenerlink = document.createAttribute("a");
      eigenerlink.
    </script>
</body>
</html>