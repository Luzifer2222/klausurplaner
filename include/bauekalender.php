...
function BaueMonatsKalender ($jahr, $monat)
{
	...
	/*
	 *Boolscherwert der auf true gesetzt wird, sobald der erste Tag in den Kalender geschrieben wurde 
	 */
	$wurdeErsterWochentagGeschrieben = false;
	
	/*
	 * Wurde mit der Nummerierung im Kalender schon begonnen wird diese Variable auf True gesetzt
	 */
